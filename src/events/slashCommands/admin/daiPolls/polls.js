        ...
        try {
            ...
            collector.on('end', async () => {
                try {
                    ...
                    // Eliminar la votación del map de votaciones activas
            ...
            // MARK: Actualizar el Embed Periódicamente
            ...
            console.error('Error en la interacción de la modal:', error);

            // Manejar el error de timeout del modal
            ...
            // Para otros errores, responder si la interacción aún es válida
            try {
